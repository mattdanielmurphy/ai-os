...
def generate(conv_id: str, title: str, app_data_dir: Path, output_path_override: Path = None):
    ...
    doc_content.append(f'<span style="display: flex; flex-direction: column-reverse; height: 100cqh; overflow-y: auto; overflow-x: hidden; box-sizing: border-box; width: 100cqw; max-width: 100cqw; min-width: 100%; position: absolute; top: 0; left: calc(50% - 50cqw); bottom: 0; padding: 2.5rem 2rem; scrollbar-width: thin;">')
