---
title: "Use `write_to_file` tool to write the content of `/Users/matt/projects/ai-os/scripts/check_merged_prs.py`. Set `Overwrite: true` in `write_to_file`."
date: "2026-08-05"
conversation_id: "1c7e3838-169c-4e5e-aea8-20f3693e9ecf"
source: "antigravity"
---

# Use `write_to_file` tool to write the content of `/Users/matt/projects/ai-os/scripts/check_merged_prs.py`. Set `Overwrite: true` in `write_to_file`.
