---
title: "In `/Users/matt/projects/jules-burner/src/daemon/health_monitor.ts`, overwrite the file with this clean, complete implementation so that offline unit tests (and production with tokens) both work reliably without false positive human alerts:"
date: "2026-08-07"
conversation_id: "cdf78e45-66e4-4c6c-abe9-756f2aeabc89"
source: "antigravity"
---

# In `/Users/matt/projects/jules-burner/src/daemon/health_monitor.ts`, overwrite the file with this clean, complete implementation so that offline unit tests (and production with tokens) both work reliably without false positive human alerts:
