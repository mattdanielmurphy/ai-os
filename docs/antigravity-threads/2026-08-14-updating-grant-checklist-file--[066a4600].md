---
title: "Updating Grant Checklist File"
date: "2026-08-14"
conversation_id: "066a4600-93bd-4d7f-b734-48ea8b939082"
source: "antigravity"
---
...
Edit the file `/Users/matt/Library/Mobile Documents/iCloud~md~obsidian/Documents/Personal/U of A/To-Do - securing grants and student aid for U of A.md`.
...
### A. Immediate & Upcoming Actions (Fall 2026 - Summer 2027)
...
- [ ] **Submit Doctor's Fee Receipt for Reimbursement:** In [Alberta Student Aid](https://sfs.studentaid.alberta.ca/SFS2R2.Web.UI.Learner/), go to **Upload e-Documents** -> select Document Type **"Disability Verification / Assessment Receipt"** and upload physician clinic invoice to claim up to $3,500 in medical form fee reimbursement.
- [ ] **Enroll in 2 Fall Classes (40% Reduced Course Load):** In [Bear Tracks](https://beartracks.ualberta.ca/) -> **Manage Classes** -> **Schedule Builder**, enroll in 2 classes (6 units) for Fall 2026.
...
- [ ] **Housing Reassessment (Rent > $934/month):**
    - To cover higher housing costs exceeding the standard $934/month shelter baseline, log into your [Alberta Student Aid account](https://sfs.studentaid.alberta.ca/SFS2R2.Web.UI.Learner/).
...
- [x] **Doctor Visits:** Completed Schedule 4 & T2201 DTC forms (Schedule 4 submitted by physician on May 4, 2026).
- [x] **Residence Application:** Reserved at Pinecrest House, $500 deposit paid.
- [x] **Alberta Student Aid Full-Time Application:** Submitted on June 4, 2026 (New Beginnings Bursary secured).
```
...
The file `/Users/matt/Library/Mobile Documents/iCloud~md~obsidian/Documents/Personal/U of A/To-Do - securing grants and student aid for U of A.md` has been successfully updated with the requested format for section 2.
