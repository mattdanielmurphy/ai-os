---
title: "In `/Users/matt/projects/jules-burner/tests/daemon/daemon.test.ts`, update the file using `write_to_file` (Overwrite: true) with this clean, complete content:"
date: "2026-08-07"
conversation_id: "0c814fac-cc90-4c75-8dca-5f31bdc198ff"
source: "antigravity"
---

# In `/Users/matt/projects/jules-burner/tests/daemon/daemon.test.ts`, update the file using `write_to_file` (Overwrite: true) with this clean, complete content:
...
describe("Jules Dispatch Daemon & Throttler Suite", () => {
  ...
  describe("Throttler", () => {
    test("tracks daily task quota and dispatches correctly", () => {
      ...
      throttler.recordDispatch("sess
<truncated 4009 bytes>
sults[i].jitterMs).toBeGreaterThanOrEqual(5000);
...
Please overwrite `/Users/matt/projects/jules-burner/tests/daemon/daemon.test.ts` directly.
