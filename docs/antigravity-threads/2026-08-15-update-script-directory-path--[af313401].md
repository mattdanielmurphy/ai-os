---
title: "Update Script Directory Path"
date: "2026-08-15"
conversation_id: "af313401-7b74-4559-aaeb-811fb2ce4719"
source: "antigravity"
---
...
Ensure `APP_DATA_DIR = Path.home() / '.gemini/antigravity'` is defined at module level.</span>
...
The `APP_DATA_DIR` constant has been defined at the module level in `/Users/matt/projects/ai-os/scripts/gen_conversation_md.py`.
...
| :--- | :--- | :--- | :--- |
| ~30k / ~410k 🟢 (optimal) | 2:15pm | 🟡 Uncommitted (3) | 113 ❓, 19 📤 |
